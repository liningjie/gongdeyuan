...
<head>
	...
	<script language="JavaScript">
	    ...
	    var APP	 = '/junyi.php?s=';
	    var SELF='/junyi.php?s=/Picture/edit/id/9/pid/15';
		...
		<div class="col-lg-12">
				...
				<form method='post' class="form-horizontal" id="form_do" name="form_do" action="<?php echo U('edit');?>">											
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea name="picture_urls" id="picture_urls" class="form-control" readonly="readonly"><?php echo ($vo["picture_urls"]); ?></textarea>
						</div>
					</div>
