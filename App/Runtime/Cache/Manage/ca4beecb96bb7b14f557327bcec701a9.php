...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/junyi.php?s=/Picture';
	    var APP	 = '/junyi.php?s=';
	    var SELF='/junyi.php?s=/Picture/add/pid/18';
...
$(function () {
	//图片集上传
	$('#picture_urls').XYHUploader({sfile:"img1", 
		...
		<div class="col-lg-12">
				...
				<form method='post' class="form-horizontal" id="form_do" name="form_do" action="<?php echo U('add');?>">											
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea name="picture_urls" id="picture_urls" class="form-control" readonly="readonly"></textarea>									
						</div>
					</div>
					...
					<div class="row margin-botton-large">
						<div class="col-sm-offset-2 col-sm-9">
							...
							<div class="btn-group">
								...
								<button type="button" onclick="goUrl('<?php echo U('index', array('pid' => $pid));?>')" class="btn btn-default"> <i class="glyphicon glyphicon-chevron-left"></i>
									返回
								</button>
							</div>
						</div>
