...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/junyi.php?s=/Category';
	    var APP	 = '/junyi.php?s=';
	    var SELF='/junyi.php?s=/Category/index';
                ...
                <div class="table-responsive">
                    <table class="table table-hover xyh-table-bordered-out">
                        ...
                        <?php if(is_array($cate)): foreach($cate as $key=>$v): ?><tr>
                                ...
                                <td>
                                <?php switch($v['status']): case "1": ?><strong class="text-success">显示</strong><?php break;?>
                                    <?php case "4": ?><strong class="text-danger"><i>禁止</i></strong><?php break;?>
                                    <?php default: ?><strong class="text-muted"><i>隐藏</i></strong><?php endswitch;?></td>
