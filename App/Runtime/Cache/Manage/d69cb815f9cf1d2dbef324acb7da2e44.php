...
<head>
	...
	<script language="JavaScript">
	    ...
	    var APP	 = '/junyi.php?s=';
	    var SELF='/junyi.php?s=/Category/edit/id/15';
									...
									<table class="table table-hover xyh-table-bordered-out-small">
										<thead>
										  ...
										  <?php if(is_array($roleList)): foreach($roleList as $key=>$v): ?><tr>
										    ...
										    <td align="center"><input type="checkbox" name="acc_role_id[]" value="audit,<?php echo ($v["id"]); ?>" <?php if(check_category_access($data['id'],'audit',$v['id']) == 1): ?>checked="checked"<?php endif; ?> /></td>
